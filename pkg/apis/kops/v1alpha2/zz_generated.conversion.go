...
func RegisterConversions(scheme *runtime.Scheme) error {
	return scheme.AddGeneratedConversionFuncs(
		...
		Convert_v1alpha2_EC2FleetInstance_To_kops_EC2FleetInstance,
		Convert_kops_EC2FleetInstance_To_v1alpha2_EC2FleetInstance,
		Convert_v1alpha2_EC2FleetSpec_To_kops_EC2FleetSpec,
		Convert_kops_EC2FleetSpec_To_v1alpha2_EC2FleetSpec,
		...
		Convert_v1alpha2_InstanceGroupFleetSpec_To_kops_InstanceGroupFleetSpec,
		Convert_kops_InstanceGroupFleetSpec_To_v1alpha2_InstanceGroupFleetSpec,
...
func autoConvert_v1alpha2_EC2FleetInstance_To_kops_EC2FleetInstance(in *EC2FleetInstance, out *kops.EC2FleetInstance, s conversion.Scope) error {
...
// Convert_v1alpha2_EC2FleetInstance_To_kops_EC2FleetInstance is an autogenerated conversion function.
func Convert_v1alpha2_EC2FleetInstance_To_kops_EC2FleetInstance(in *EC2FleetInstance, out *kops.EC2FleetInstance, s conversion.Scope) error {
	return autoConvert_v1alpha2_EC2FleetInstance_To_kops_EC2FleetInstance(in, out, s)
}

func autoConvert_kops_EC2FleetInstance_To_v1alpha2_EC2FleetInstance(in *kops.EC2FleetInstance, out *EC2FleetInstance, s conversion.Scope) error {
	out.InstanceType = in.InstanceType
	if in.Weight != nil {
		in, out := &in.Weight, &out.Weight
		*out = new(int)
...
// Convert_kops_EC2FleetInstance_To_v1alpha2_EC2FleetInstance is an autogenerated conversion function.
func Convert_kops_EC2FleetInstance_To_v1alpha2_EC2FleetInstance(in *kops.EC2FleetInstance, out *EC2FleetInstance, s conversion.Scope) error {
	return autoConvert_kops_EC2FleetInstance_To_v1alpha2_EC2FleetInstance(in, out, s)
}

func autoConvert_v1alpha2_EC2FleetSpec_To_kops_EC2FleetSpec(in *EC2FleetSpec, out *kops.EC2FleetSpec, s conversion.Scope) error {
	out.AllocationStrategy = in.AllocationStrategy
	out.Distribution = in.Distribution
	if in.InstancesTypes != nil {
		in, out := &in.InstancesTypes, &out.InstancesTypes
		*out = make([]kops.EC2FleetInstance, len(*in))
		for i := range *in {
			if err := Convert_v1alpha2_EC2FleetInstance_To_kops_EC2FleetInstance(&(*in)[i], &(*out)[i], s); err != nil {
				return err
			}
		}
	} else {
		out.InstancesTypes = nil
	}
	...
	if in.SpotAllocationStrategy != nil {
		...
		**out = int64(**in)
		...
		out.SpotAllocationStrategy = nil
	}
	return nil
}

// Convert_v1alpha2_EC2FleetSpec_To_kops_EC2FleetSpec is an autogenerated conversion function.
func Convert_v1alpha2_EC2FleetSpec_To_kops_EC2FleetSpec(in *EC2FleetSpec, out *kops.EC2FleetSpec, s conversion.Scope) error {
	return autoConvert_v1alpha2_EC2FleetSpec_To_kops_EC2FleetSpec(in, out, s)
}

func autoConvert_kops_EC2FleetSpec_To_v1alpha2_EC2FleetSpec(in *kops.EC2FleetSpec, out *EC2FleetSpec, s conversion.Scope) error {
	out.AllocationStrategy = in.AllocationStrategy
	out.Distribution = in.Distribution
	if in.InstancesTypes != nil {
		in, out := &in.InstancesTypes, &out.InstancesTypes
		*out = make([]EC2FleetInstance, len(*in))
		for i := range *in {
			if err := Convert_kops_EC2FleetInstance_To_v1alpha2_EC2FleetInstance(&(*in)[i], &(*out)[i], s); err != nil {
				return err
			}
		}
	} else {
...
// Convert_kops_EC2FleetSpec_To_v1alpha2_EC2FleetSpec is an autogenerated conversion function.
func Convert_kops_EC2FleetSpec_To_v1alpha2_EC2FleetSpec(in *kops.EC2FleetSpec, out *EC2FleetSpec, s conversion.Scope) error {
	return autoConvert_kops_EC2FleetSpec_To_v1alpha2_EC2FleetSpec(in, out, s)
}
...
func autoConvert_v1alpha2_InstanceGroupFleetSpec_To_kops_InstanceGroupFleetSpec(in *InstanceGroupFleetSpec, out *kops.InstanceGroupFleetSpec, s conversion.Scope) error {
	if in.EC2Fleet != nil {
		in, out := &in.EC2Fleet, &out.EC2Fleet
		*out = new(kops.EC2FleetSpec)
		if err := Convert_v1alpha2_EC2FleetSpec_To_kops_EC2FleetSpec(*in, *out, s); err != nil {
			return err
		}
	} else {
		out.EC2Fleet = nil
...
// Convert_v1alpha2_InstanceGroupFleetSpec_To_kops_InstanceGroupFleetSpec is an autogenerated conversion function.
func Convert_v1alpha2_InstanceGroupFleetSpec_To_kops_InstanceGroupFleetSpec(in *InstanceGroupFleetSpec, out *kops.InstanceGroupFleetSpec, s conversion.Scope) error {
	return autoConvert_v1alpha2_InstanceGroupFleetSpec_To_kops_InstanceGroupFleetSpec(in, out, s)
}

func autoConvert_kops_InstanceGroupFleetSpec_To_v1alpha2_InstanceGroupFleetSpec(in *kops.InstanceGroupFleetSpec, out *InstanceGroupFleetSpec, s conversion.Scope) error {
	if in.EC2Fleet != nil {
		in, out := &in.EC2Fleet, &out.EC2Fleet
		*out = new(EC2FleetSpec)
		if err := Convert_kops_EC2FleetSpec_To_v1alpha2_EC2FleetSpec(*in, *out, s); err != nil {
			return err
		}
	} else {
		out.EC2Fleet = nil
...
// Convert_kops_InstanceGroupFleetSpec_To_v1alpha2_InstanceGroupFleetSpec is an autogenerated conversion function.
func Convert_kops_InstanceGroupFleetSpec_To_v1alpha2_InstanceGroupFleetSpec(in *kops.InstanceGroupFleetSpec, out *InstanceGroupFleetSpec, s conversion.Scope) error {
	return autoConvert_kops_InstanceGroupFleetSpec_To_v1alpha2_InstanceGroupFleetSpec(in, out, s)
}
...
func autoConvert_v1alpha2_InstanceGroupSpec_To_kops_InstanceGroupSpec(in *InstanceGroupSpec, out *kops.InstanceGroupSpec, s conversion.Scope) error {
	...
	if in.FleetSpec != nil {
		...
		*out = new(kops.InstanceGroupFleetSpec)
		if err := Convert_v1alpha2_InstanceGroupFleetSpec_To_kops_InstanceGroupFleetSpec(*in, *out, s); err != nil {
			return err
		}
	} else {
		out.FleetSpec = nil
...
func autoConvert_kops_InstanceGroupSpec_To_v1alpha2_InstanceGroupSpec(in *kops.InstanceGroupSpec, out *InstanceGroupSpec, s conversion.Scope) error {
	...
	if in.FleetSpec != nil {
		in, out := &in.FleetSpec, &out.FleetSpec
		*out = new(InstanceGroupFleetSpec)
		if err := Convert_kops_InstanceGroupFleetSpec_To_v1alpha2_InstanceGroupFleetSpec(*in, *out, s); err != nil {
			return err
		}
	} else {
		out.FleetSpec = nil
